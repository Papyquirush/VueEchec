...
export class GameService {
    ...
    public async nextTurnAfterPromote(id: number, position: string,pieceType: string) {
        ...
        if (game) {
            ...
            await this.updateGame(id, game.player_white_id, game.player_black_id, game.is_public, gameState.pieces, game.is_finished, undefined, game.turn_count ,undefined,0);
        }
    }
