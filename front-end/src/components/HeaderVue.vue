              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  <MenuButton class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <img class="size-8 rounded-full" src="@/assets/images/Ubik_Manga.jpg" alt="PP" />
                  </MenuButton>
                </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="@/assets/images/Ubik_Manga.jpg" alt="" />
            </div>
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Jean Test</div>
              <div class="text-sm font-medium text-gray-400">jean.test@gmail.com</div>
            </div>
